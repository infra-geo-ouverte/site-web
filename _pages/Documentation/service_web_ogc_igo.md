...
##### Le service de fond de carte public est le suivant : **carte_gouv_qc_public**. Il présente un fond de carte de base (routes, hydrographie, lieux d'intérêt) basé sur des données gouvernementales. Il peut être accédé par l'entremise de cet URL de service WMTS mis à jour régulièrement : [https://geoegl.msp.gouv.qc.ca/carto/wmts?SERVICE=WMTS&REQUEST=GetCapabilities&VERSION=1.0.0](https://geoegl.msp.gouv.qc.ca/carto/wmts?SERVICE=WMTS&REQUEST=GetCapabilities&VERSION=1.0.0). 
...
#### Le service de fond de carte - Imagerie du gouvernement du Québec est une mosaïque d'images aériennes acquises dans le cadre du partenariat d'acquisition d'orthophographies gouvernemental.
