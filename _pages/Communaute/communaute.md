...
<a id="mission" name="1 Mission de la communauté IGO "></a>
...
<a id="structure" name="2 Structure de la communauté IGO "></a>
...
## 6 Principes et mécanismes de prise des décisions
...
- La notation suivante pour le vote est adoptée : +1, 0, -1: 
	1. +: signifie « je suis d'accord et m'engage à supporter cette décision et collaborer à sa réalisation » ;
	2. 0: signifie « je m'abstiens » ;
	3. -1: signifie « j'ai une objection ». Ceci est considéré comme étant un veto. Dans ce cas, la personne votante est dans l'obligation de fournir une motion alternative ;
...
##7 Charte du comité technique 
Se référer à **l'annexe 2 (mettre le lien)**

##8 Convention et règles de codage
...
##9 Dépôt du code source et outils de communications 
...
- Un ou des validateurs de code vont réviser et endosser ces modifications pour inclusion officielle dans le logiciel. Cela permet de gagner la confiance des autres validateurs de code ; 
